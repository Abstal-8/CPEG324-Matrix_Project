...
module multiplier_4bit (
    ...
    assign P_rslt[0] = p0[0];

    // Row 1 Addition (p0[3:1] + p1[2:0])
    half_adder ha1_0 (p0[1], p1[0], P_rslt[1], c1[0]);
    ...
    half_adder ha2_0 (s1[0], p2[0], P_rslt[2], c2[0]);
    ...
    half_adder ha3_0 (s2[0], p3[0], P_rslt[3], c3[0]);
    full_adder fa3_1 (s2[1], p3[1], c3[0], P_rslt[4], c3[1]);
    full_adder fa3_2 (s2[2], p3[2], c3[1], P_rslt[5], c3[2]);
    full_adder fa3_3 (c2[3], p3[3], c3[2], P_rslt[6], P_rslt[7]); // Carry out is P[7]
